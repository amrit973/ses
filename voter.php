                               ...
                               <div class="col-md-9 col-lg-9 col-sm-9 col-xs-9">
                                  <table class="table table-hover table-responsive">
                                         <tbody>
                                               ...
                                               <tr>
                                                    <td>GUARDIAN NAME :</td>
                                                    <td>________ CHAUHAN</td>
                                               </tr>
                                               <tr>
                                                    <td>ADDRESS :</td>
                                                    <td>ALPHA-1 FLAT NO-10;</td>
                                               </tr>
                                               <tr>
                                                    <td>PIN :</td>
                                                    <td>201310</td>
                                  ...
                                  <button class="btn btn-primary" >VOTE <span class="glyphicon glyphicon-hand-up"></span></button>&nbsp;&nbsp;
                                  <button class="btn btn-primary">MESSAGE &nbsp;<span class="glyphicon glyphicon-envelope"></span></button>
                                  </div>
                                  </div>
                           </div>
                       </div>
